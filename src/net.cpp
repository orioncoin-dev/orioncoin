...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Orioncoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"213.196.46.166", "213.196.46.166"},
    {"213.196.46.168", "213.196.46.168"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Orioncoin is probably already running."), addrBind.ToString().c_str());
        else
